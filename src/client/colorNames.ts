// Nearest-match naming against the Wikipedia "List of colors (alphabetical)"
// dataset (https://en.wikipedia.org/wiki/List_of_colors_(alphabetical)),
// covering ~1200 named colors for a much closer perceptual match than the
// ~140 CSS extended keywords used previously.
